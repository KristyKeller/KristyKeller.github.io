...
export default
    {
        ...
        headerBrand:
        [
        "Full-Stack Web Development • Coding • Testing • Web Design • Product Management • Content Writing • eCommerce"
            ],
        // About Me
        abouttext: [
        ...
        "I graduated with dual Master's degrees in Business Administration and Media Communication from Point Park University along with a Bachelor's degree in Communication from Keystone College. I have a Full-Stack Web Development certificate from the University of Pennsylvania. I also have experience as a freelance Content Marketer along with being an eCommerce Content Specialist at Dick's Sporting Goods.",
        "From design to execution, I utilize innovation and technical skills to provide seamless end to end projects and results through JavaScript, HTML5, CSS3, Reactjs, Jest Testing, jQuery, Bootstrap, MySql, MongoDB, and other libraries and frameworks. Check out my projects for a better look at my way of thinking."],
        aboutImage: "https://i.ibb.co/jbt1n27/bio-photo.jpg",
        ShowAboutImage: true,
        projects: [
            {
                id: 1,
